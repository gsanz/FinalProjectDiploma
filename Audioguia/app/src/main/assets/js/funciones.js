...
var nombreJugador1 = "Jugador 1"; var nombreJugador2 = "Jugador 2";
...
function ver_ciudad(ciudad){
alert("La ciudad es "+ciudad);
}
...
if (numJugadas >= tamano*tamano) {
      document.getElementById("turno").innerHTML = jsInterfazNativa.mensaje("Fin del Juego: EMPATE"); 
finDelJuego = true;
return;
} }
